...
describe('extract-text-signals', () => {
  describe('extracts keywords from valid text', () => {
    test.each<Case>([
      [
        'finds trail keyword in simple text',
        'Morning trail run',
        ['trail'],
      ],
      [
        'finds road keyword in simple text',
        'Easy road run',
        ['road'],
      ],
      [
        'finds track keyword in simple text',
        'Track workout session',
        ['track'],
      ],
      [
        'finds indoor keyword in simple text',
        'Indoor cycling workout',
        ['indoor'],
      ],
      [
        'finds outdoor keyword in simple text',
        'Outdoor adventure',
        ['outdoor'],
      ],
      [
        'finds park keyword in simple text',
        'Running in the park',
        ['park'],
      ],
      [
        'finds beach keyword in simple text',
        'Beach run at sunrise',
        ['beach'],
      ],
      [
        'finds mountain keyword in simple text',
        'Mountain bike ride',
        ['mountain'],
      ],
      [
        'finds hill keyword in simple text',
        'Hill repeats workout',
        ['hill'],
      ],
      [
        'finds multiple keywords in text',
        'Trail run in the mountain',
        ['trail', 'mountain'],
      ],
      [
        'finds multiple keywords with mixed case',
        'OUTDOOR PARK RUN',
        ['outdoor', 'park'],
      ],
      [
        'extracts keywords from text with extra spaces',
        '  trail   run  ',
        ['trail'],
      ],
      [
        'finds keywords in lowercase text',
        'trail run',
        ['trail'],
      ],
      [
        'finds keywords in uppercase text',
        'TRAIL RUN',
        ['trail'],
      ],
      [
        'finds keywords in mixed case text',
        'Trail Run',
        ['trail'],
      ],
      [
      ...
      [
        'finds road and park keywords together',
        'Road cycling through city park',
        ['road', 'park'],
      ],
      [
      ...
      [
        'finds hill keyword in hillside',
  ...
  describe('returns undefined when no keywords found', () => {
    test.each<Case>([
      ...
      [
        'returns undefined for whitespace only',
        '   ',
        undefined,
      ],
      [
        'returns empty array for text with no keywords',
        'Morning run workout',
        [],
      ],
      [
      ...
      [
        'returns empty array for numeric text',
        '12345',
        [],
      ],
      [
      ...
      [
        'returns empty array for gibberish text',
        'xyzabc defghi',
        [],
      ],
      [
  ...
  describe('handles edge cases gracefully', () => {
    test.each<Case>([
      [
        'handles text with only spaces before keyword',
        '     trail',
        ['trail'],
      ],
      [
        'handles text with only spaces after keyword',
        'trail     ',
        ['trail'],
      ],
      [
      ...
      [
        'handles text with duplicate keywords',
        'trail trail trail',
        ['trail'],
      ],
      [
      ...
      [
        'handles single character keywords not matching',
        'a b c d',
        [],
      ],
      [

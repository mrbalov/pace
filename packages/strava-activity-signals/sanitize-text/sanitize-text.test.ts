...
describe('sanitize-text', () => {
  describe('sanitizes safe text correctly', () => {
    test.each<Case>([
      [
        'returns trimmed text for simple input',
        '  Morning run  ',
        'Morning run',
      ],
      [
      ...
      [
        'normalizes tabs to single space',
        'Morning\t\trun\tworkout',
        'Morning run workout',
      ],
      [
        'normalizes newlines to single space',
        'Morning\nrun\nworkout',
        'Morning run workout',
      ],
      [
      ...
      [
        'preserves text with special characters',
        'Morning run @ 5k!',
        'Morning run @ 5k!',
      ],
      [
        'preserves text with numbers',
        'Morning run 10k',
        'Morning run 10k',
      ],
      [
        'preserves text with punctuation',
        'Morning run, very nice!',
        'Morning run, very nice!',
      ],
      [
        'preserves text with hyphens',
        'Trail-running adventure',
        'Trail-running adventure',
      ],
      [
        'preserves text with apostrophes',
        "It's a great run",
        "It's a great run",
      ],
      [
        'handles text with only spaces at start',
        '     Trail run',
        'Trail run',
      ],
      [
        'handles text with only spaces at end',
        'Trail run     ',
        'Trail run',
      ],
      [
        'handles text with spaces on both ends',
        '   Trail run   ',
        'Trail run',
      ],
      [
  ...
  describe('removes forbidden content', () => {
    test.each<Case>([
      [
        ...
        'Running with people in the park',
        '',
      ],
      [
        'returns empty string for text with face keywords',
        'Morning run with portrait photo',
        '',
      ],
      [
      ...
      [
        ...
        'Running with weapon training',
        '',
      ],
      [
        'returns empty string for text with combat keywords',
        'Military training run',
        '',
      ],
      [
        'returns empty string for text with sexual keywords',
        'Explicit content in description',
        '',
      ],
      [
      ...
      [
        'returns empty string for uppercase forbidden keywords',
        'PEOPLE RUNNING',
        '',
      ],
      [
        'returns empty string for mixed case forbidden keywords',
        'PeOpLe running',
        '',
      ],
      [
      ...
      [
        ...
        'Morning run with people',
        '',
      ],
      [
        'returns empty string for forbidden keyword in middle',
        'Great people filled run',
        '',
      ],
      [
        'returns empty string for text with man keyword',
        'Man running marathon',
        '',
      ],
      [
        'returns empty string for text with woman keyword',
        'Woman jogging',
        '',
      ],
      [
        'returns empty string for text with child keyword',
        'Child playing',
        '',
      ],
      [
      ...
      [
        'returns empty string for text with flag keyword',
        'Running past the flag',
        '',
      ],
      [
        'returns empty string for text with army keyword',
        'Army base run',
        '',
      ],
    ])('%#. %s', (_name, input, expected) => {
  ...
  describe('handles edge cases', () => {
    test.each<Case>([
      ...
      [
        'handles two characters',
        'ab',
        'ab',
      ],
      [
        'handles very short safe text',
        'run',
        'run',
      ],
      [
      ...
      [
        'handles text starting with special character',
        '!Important',
        '!Important',
      ],
      [
        'handles text ending with special character',
        'Important!',
        'Important!',
      ],
      [
        'handles text with only numbers',
        '12345',
        '12345',
      ],
      [
      ...
      [
        'handles text with leading tabs and trailing spaces',
        '\t\tRun   ',
        'Run',
      ],
      [
